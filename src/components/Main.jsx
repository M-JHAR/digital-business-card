    ...
    return (
        <main className="main">
            <div className="header-links">
                <a className="email-link header-link" href="mailto:jharmostafa@gmail.com">
                ...
                <a className="linkedin-link header-link" href="https://www.linkedin.com/in/mustafa-jhar-0692542aa/">
